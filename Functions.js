  ...
  async Player(message, Discord, client, Ytdl, options = {}, db) {
    ...
    if (!options.Play) {
      ...
      const Embeded = new Discord.MessageEmbed()
        ...
        .setDescription(
          "A fila do servidor foi encerrada, obrigado por me ouvir <3\n\nDica profissional: você pode usar o comando ** 24,7 ** para torná-lo 24 horas por dia, 7 dias por semana :D"
        )
        .setTimestamp();
